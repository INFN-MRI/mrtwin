...
__all__ = ["FuzzyMWMTBrainwebPhantom", "CrispMWMTBrainwebPhantom", "NumericMWMTBrainwebPhantom"]

import numpy as np

from .. import _classes

from ._brainweb import FuzzyBrainwebPhantom, CrispBrainwebPhantom, NumericBrainwebPhantom
...
class FuzzyMWMTBrainwebPhantom(FuzzyBrainwebPhantom):
    ...
    def get_model(self, B0: float):
        ...
        self._label = []
        self._properties = {"MWF": [], "MVF": [], "T1w": [], "T1m": [], "T2w": [], "T2m": [], "kmw": [], "kmt": [], "chemshift": []}
        ...
        self._properties["chemshift"] = np.asarray(self._properties["chemshift"], dtype=np.float32)
...
class NumericMWMTBrainwebPhantom(FuzzyMWMTBrainwebPhantom, NumericBrainwebPhantom): # noqa
