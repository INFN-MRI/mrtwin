...
def get_osf_dir(osf_dir: OSFDirType = None) -> Path:
...
def get_osf_maps(
    ...
    # Stack maps
    data = np.stack([data["PD"], data["qT1"], data["qT2"], data["qT2STAR"], data["QSM"]], axis=0)
